...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 8.728;//8.5; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -4.5;//-6.2; // in; offset of the lateral wheel
